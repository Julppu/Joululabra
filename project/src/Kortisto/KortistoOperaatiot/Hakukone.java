...
public class Hakukone implements Serializable {
     ...
     * joko sen tai null, jos teosta ei löydy. Vain yksi metodi käyttää, käytän-
     * nön syistä jätetty.
     * 
     * @param kortisto kortiston instanssi
    ...
    /**
     * Hakee yksittäistä tietyn lehden numeroa sen tunnuksen ja numeron julkaisu-
     * vuoden ja -numeron perusteella.
     * 
     * @param kortisto kortisto josta numeroa haetaan
     * @param ID haettavan lehden tunnus
     * @param vuosi haettava vuosikerta
     * @param numero haettava julkaisunumero
     * @return joko löytynyt lehti tai null
     */
